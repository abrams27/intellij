...
2. Run `bazel run //newplugin/server/install:install -- <installer flags>` (`--help` is available)
...
4. Publish a new version:
   ```shell
   bazel run --stamp --define "maven_repo=file://$HOME/.m2/repository" //newplugin/server/src/main/kotlin/org/jetbrains/bsp/bazel:bsp.publish
   ```
